...
/* Generate Venom-128 keypair and output lengths. */
int kem_keygen(
...
/* Encapsulate with Venom-128 public key and output lengths. */
int kem_enc(
    unsigned char *pk, unsigned long long pk_len_bytes,
...
/* Decapsulate Venom-128 ciphertext and output shared-secret length. */
int kem_dec(
    unsigned char *sk, unsigned long long sk_len_bytes,
    unsigned char *ct, unsigned long long ct_len_bytes,
    unsigned char *ss, unsigned long long *ss_len_bytes)
