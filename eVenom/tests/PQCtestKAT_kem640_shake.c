/********************************************************************************************
* Abstract: run tests against known answer test vectors for eMAMBA-Venom-640 using SHAKE128
*
...
char    AlgName[] = "eMAMBA-Venom-640-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_enc_eVenom640(ct, ss, pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_eVenom640(ss1, ct, sk)) != 0) {
