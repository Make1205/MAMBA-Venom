/********************************************************************************************
* Abstract: run tests against known answer test vectors for eMAMBA-Venom-976 using SHAKE128
*
...
#include <ctype.h>
#include "rng.h"
#include "../src/api_venom3.h"

char    AlgName[] = "eMAMBA-Venom-976-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_enc_eVenom976(ct, ss, pk, sk)) != 0) {
            printf("crypto_kem_keypair_enc returned <%d>\n", ret_val);
        ...
        if ( (ret_val = crypto_kem_dec_eVenom976(ss1, ct, sk)) != 0) {
