/********************************************************************************************
* Abstract: run tests against known answer test vectors for eMAMBA-Frost-976 using SHAKE128
*
...
char    AlgName[] = "eMAMBA-Frost-976-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_enc_eFrost976(ct, ss, pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_eFrost976(ss1, ct, sk)) != 0) {
