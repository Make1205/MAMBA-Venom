...
*
* Abstract: parameters and API for eMAMBA-Frost-3
*********************************************************************************************/

#ifndef _API_eFrost976_H_
#define _API_eFrost976_H_
...
// Algorithm name
#define CRYPTO_ALGNAME "eMAMBA-Frost-3"


int crypto_kem_keypair_enc_eFrost976(unsigned char *ct, unsigned char *ss, unsigned char *pk, unsigned char* sk);
int crypto_kem_dec_eFrost976(unsigned char *ss, const unsigned char *ct, const unsigned char *sk);
