...
class NISTKAT(object):
    ...
    class NISTRNG(object):
        ...
        when run on MAMBA-Frost; note that this is not a proper implementation of that RNG, 
...
if __name__ == "__main__":
    # Run KATs for all supported MAMBA-Frost variants
    katvalues = NISTKAT.run(MAMBA-Frost('MAMBA-Frost-640-AES'))
    NISTKAT.check(katvalues, 'PQCkemKAT_19888.rsp')
    katvalues = NISTKAT.run(MAMBA-Frost('MAMBA-Frost-640-SHAKE'))
    NISTKAT.check(katvalues, 'PQCkemKAT_19888_shake.rsp')
    katvalues = NISTKAT.run(MAMBA-Frost('MAMBA-Frost-976-AES'))
    NISTKAT.check(katvalues, 'PQCkemKAT_31296.rsp')
    katvalues = NISTKAT.run(MAMBA-Frost('MAMBA-Frost-976-SHAKE'))
    NISTKAT.check(katvalues, 'PQCkemKAT_31296_shake.rsp')
    katvalues = NISTKAT.run(MAMBA-Frost('MAMBA-Frost-1344-AES'))
    NISTKAT.check(katvalues, 'PQCkemKAT_43088.rsp')
    katvalues = NISTKAT.run(MAMBA-Frost('MAMBA-Frost-1344-SHAKE'))
