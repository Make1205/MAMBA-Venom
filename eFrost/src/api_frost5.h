...
*
* Abstract: parameters and API for eMAMBA-Frost-5
*********************************************************************************************/

#ifndef _API_eFrost1344_H_
#define _API_eFrost1344_H_
...
// Algorithm name
#define CRYPTO_ALGNAME "eMAMBA-Frost-5"


int crypto_kem_keypair_enc_eFrost1344(unsigned char* ct, unsigned char* ss, unsigned char* pk, unsigned char* sk);
int crypto_kem_dec_eFrost1344(unsigned char *ss, const unsigned char *ct, const unsigned char *sk);
