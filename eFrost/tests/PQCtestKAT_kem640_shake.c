/********************************************************************************************
* Abstract: run tests against known answer test vectors for eMAMBA-Frost-640 using SHAKE128
*
...
char    AlgName[] = "eMAMBA-Frost-640-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_enc_eFrost640(ct, ss, pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_eFrost640(ss1, ct, sk)) != 0) {
