...
import os
from frodokem import MAMBA-Venom
...
class NISTKAT(object):
    ...
    class NISTRNG(object):
        ...
        when run on MAMBA-Venom; note that this is not a proper implementation of that RNG, 
...
if __name__ == "__main__":
    # Run KATs for all supported MAMBA-Venom variants
    katvalues = NISTKAT.run(MAMBA-Venom('MAMBA-Venom-640-AES'))
    NISTKAT.check(katvalues, 'PQCkemKAT_19888.rsp')
    katvalues = NISTKAT.run(MAMBA-Venom('MAMBA-Venom-640-SHAKE'))
    NISTKAT.check(katvalues, 'PQCkemKAT_19888_shake.rsp')
    katvalues = NISTKAT.run(MAMBA-Venom('MAMBA-Venom-976-AES'))
    NISTKAT.check(katvalues, 'PQCkemKAT_31296.rsp')
    katvalues = NISTKAT.run(MAMBA-Venom('MAMBA-Venom-976-SHAKE'))
    NISTKAT.check(katvalues, 'PQCkemKAT_31296_shake.rsp')
    katvalues = NISTKAT.run(MAMBA-Venom('MAMBA-Venom-1344-AES'))
    NISTKAT.check(katvalues, 'PQCkemKAT_43088.rsp')
    katvalues = NISTKAT.run(MAMBA-Venom('MAMBA-Venom-1344-SHAKE'))
