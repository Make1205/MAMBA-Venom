...
frost_level_params(){
  case "$1" in
    ...
    192) echo "q=65536,qbits=16,n=872,m=872,ell=8,eta_s=1,eta_r=1,b_msg=3,t_pk=11,t_u=11,t_v=8" ;;
    256) echo "q=65536,qbits=16,n=1280,m=1280,ell=8,eta_s=1,eta_r=1,b_msg=4,t_pk=13,t_u=12,t_v=7" ;;
...
frost_expected_sizes(){
  case "$1" in
    ...
    192) echo "9624,9688,11432,24" ;;
    256) echo "16672,15448,19296,32" ;;
