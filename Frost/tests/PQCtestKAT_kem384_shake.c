/********************************************************************************************
* Abstract: run tests against known answer test vectors for Frost-384 using SHAKE128
*
...
char    AlgName[] = "MAMBA-Frost-384-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_Frost384(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_Frost384(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_Frost384(ss1, ct, sk)) != 0) {
