/********************************************************************************************
* Abstract: run tests against known answer test vectors for Frost-192 using SHAKE128
*
...
char    AlgName[] = "MAMBA-Frost-192-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_Frost192(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_Frost192(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_Frost192(ss1, ct, sk)) != 0) {
