/********************************************************************************************
* Abstract: run tests against known answer test vectors for Frost-256 using SHAKE128
*
...
char    AlgName[] = "MAMBA-Frost-256-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_Frost256(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_Frost256(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_Frost256(ss1, ct, sk)) != 0) {
