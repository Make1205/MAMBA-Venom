/********************************************************************************************
* Abstract: run tests against known answer test vectors for Frost-128 using SHAKE128
*
...
char    AlgName[] = "MAMBA-Frost-128-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_Frost128(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_Frost128(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_Frost128(ss1, ct, sk)) != 0) {
