/********************************************************************************************
* Abstract: run tests against known answer test vectors for Frost-512 using SHAKE128
*
...
char    AlgName[] = "MAMBA-Frost-512-SHAKE";
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_Frost512(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_Frost512(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_Frost512(ss1, ct, sk)) != 0) {
