...
int main(void)
{
    const profile_t profiles[] = {
        ...
        { "MAMBA-Frost-192", 920, 920, 8, 16, 1, 1, 3, 12, 11, 7, PK192, CT192, SK192, SS192, 11072, 10208, 12976, 24 },
        { "MAMBA-Frost-256", 1288, 1288, 8, 16, 1, 1, 4, 13, 13, 7, PK256, CT256, SK256, SS256, 16776, 16832, 19416, 32 },
