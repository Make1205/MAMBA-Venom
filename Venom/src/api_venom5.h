...
#define CRYPTO_PUBLICKEYBYTES  13472     // sizeof(seed_A) + (PARAMS_PK_LOGP2*PARAMS_N*PARAMS_NBAR)/8
#define CRYPTO_BYTES              32
#define CRYPTO_CIPHERTEXTBYTES 13504     // (PARAMS_U_LOGP2*PARAMS_N*PARAMS_NBAR)/8 + (PARAMS_V_LOGP2*PARAMS_NBAR*PARAMS_NBAR)/8 + BYTES_SALT
