/********************************************************************************************
* Abstract: run tests against known answer test vectors for Venom-384 using SHAKE128
*
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_Venom384(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_Venom384(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_Venom384(ss1, ct, sk)) != 0) {
