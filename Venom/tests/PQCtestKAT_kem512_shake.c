/********************************************************************************************
* Abstract: run tests against known answer test vectors for Venom-512 using SHAKE128
*
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_dec_Venom512(ss1, ct, sk)) != 0) {
