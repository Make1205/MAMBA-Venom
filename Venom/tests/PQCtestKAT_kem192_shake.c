/********************************************************************************************
* Abstract: run tests against known answer test vectors for Venom-192 using SHAKE128
*
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_Venom192(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_Venom192(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_Venom192(ss1, ct, sk)) != 0) {
